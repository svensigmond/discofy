...
var discollection = new _vue2.default({
	...
	methods: {
		...
		setUserData: function setUserData() {
			...
			_discogs2.default.getUserData(this.id).then(function (response) {
		...
		setCollectionData: function setCollectionData(url) {
			...
			_discogs2.default.getCollectionData(this.id, url, activeSorting).then(function (response) {
...
var albumDetails = _vue2.default.component('component-album-details', {
	props: ['details'],
	...
	methods: {
		...
		onClose: function onClose() {
			_eventbus2.default.$emit('detail:close');
		}
	}
});
...
var album2 = _vue2.default.component('component-album', {
	props: ['album'],
...
var user = _vue2.default.component('component-user', {
	props: ['user'],
